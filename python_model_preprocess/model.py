...
class Model(object):
    def __init__(self, config):
        ...
        length = tf.reduce_sum(used, reduction_indices=1,name='lengths')
        ...
        print('logits_name:',self.logits.name)
        # loss of the model
    ...
    def project_layer(self, lstm_outputs, name=None):
        ...
        with tf.variable_scope("project"  if not name else name):
            ...
            return tf.reshape(pred, [-1, self.num_steps, self.num_tags],name='logits_output')
